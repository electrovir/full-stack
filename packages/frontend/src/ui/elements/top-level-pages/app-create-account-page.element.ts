...
import {AppCreateAccount} from '../sign-in/app-create-account.element.js';

export const AppCreateAccountPage = defineElement<
    Readonly<
        PendingFrontendState<
            (typeof frontendPathTree.paths.children)['create-account']['PathsType']
        >
    >
>()({
    ...
    render({inputs, dispatch}) {
        ...
        return html`
            <${AppCreateAccount.assign(resolvedState.resolvedNoUser)}></${AppCreateAccount}>
        `;
    },
});
